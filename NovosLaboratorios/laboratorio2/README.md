...
Com base no que foi abordado neste ultimo tópico, adicione uma descrição personalizada para todos os métodos de nosso **BookEndpoint**, o código base para este exercício pode ser encontrado
