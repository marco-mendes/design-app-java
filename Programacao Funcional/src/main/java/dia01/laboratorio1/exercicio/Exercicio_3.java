package dia01.laboratorio1.exercicio;

/*
 * Com base no Exemplo 3 crie uma interface funcional chamada ComplexOperator, essa interface deve possuir um método chamado apply que recebe um valor genérico
